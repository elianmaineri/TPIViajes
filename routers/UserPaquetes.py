...
@paquetes_router.get('/ALL-PAQUETES', tags=['Paquetes'], response_model=List[PaquetesDeViaje], status_code=200)
...
@paquetes_router.get('/DESTINO-PAQUETE', tags=['Paquetes'], response_model=List[PaquetesDeViaje], status_code=200)
...
def update_paquetes(id: int, paquete: PaquetesDeViaje):
    db = Session()
